...
Config.PedSpawn = {
    { model = 's_m_m_movspace_01', coords = vec4(53.4131, 114.8203, 78.1969, 326.4925) },
    { model = 's_m_m_movspace_01', coords = vec4(57.3836, 125.7354, 78.3044, 249.3264) },
    { model = 's_m_m_movspace_01', coords =  vec4(66.7885, 128.5620, 78.1955, 162.3291) },
}
...
Config.BlipColour = 0
Config.BlipSize = 0.6
Config.BlipText = '<font face ="AMSANSL">GoPostal</font>'